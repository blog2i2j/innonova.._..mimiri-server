...
namespace Mimer.Notes.Model.Requests {
	public class ShareParticipantsRequest : ISignable, IRequestObject, INonRepeatableRequest {
		private JsonObject _json;

		public ShareParticipantsRequest() {
			_json = new JsonObject();
			TimeStamp = DateTime.UtcNow;
			RequestId = Guid.NewGuid();
		}

		public ShareParticipantsRequest(JsonObject json) {
			_json = json;
		}

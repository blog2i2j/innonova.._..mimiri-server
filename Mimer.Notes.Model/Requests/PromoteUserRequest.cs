...
namespace Mimer.Notes.Model.Requests {
	public class PromoteUserRequest : ISignable, IRequestObject, INonRepeatableRequest {
		...
		public PromoteUserRequest(JsonObject json) {
			_json = json;
		}
		...
		public string TargetUsername {
			get {
				return _json.String("targetUsername");
			}
			set {
				_json.String("targetUsername", value);
			}
		}
